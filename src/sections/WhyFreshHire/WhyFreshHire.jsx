            ...
            <div className="whyFreshHire">
                <div className="whyFreshHire__left">
                    <div className='whyFreshHire__left__content'>
                        <p><img src={wavyCheck} alt="" /><span>100% easy onboarding, No hassel</span></p>
                        <p><img src={wavyCheck} alt="" /><span>Over 10,000+ new jobs every week</span></p>
                        <p><img src={wavyCheck} alt="" /><span>We are partnered with world class companies</span></p>
                        <p><img src={wavyCheck} alt="" /><span>100% User friendly</span></p>
                        <p><img src={wavyCheck} alt="" /><span>Perfect hiring process</span></p>
                        <p><img src={wavyCheck} alt="" /><span>Proof of quality</span></p>
                        <p><img src={wavyCheck} alt="" /><span>Safe and secure</span></p>
                    </div>
                </div>
                ...
                <img className='whyFreshHire__female__illustration' src={female} alt="" />
            </div></div>
